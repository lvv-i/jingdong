...
|---|------|------|--------------------------|------|
| T1 | 状态机枚举表（4 类状态机 + 流转规则，全员签字版） | Day 1 | `01-状态机枚举表.md` | ✅ 已完成（v1.0 全员签字） |
| T2 | 数据字典 v1.0（核心 13 张表字段清单） | Day 2 | `02-数据字典v1.0.md` | ✅ 已完成 |
| T3 | 错误码分段表（7 段 + 公共错误码） | Day 2 | `03-错误码分段表.md` | ✅ 已完成 |
| T4 | JWT 鉴权与 RBAC 权限方案 | Day 2 | `04-JWT鉴权与RBAC方案.md` | ✅ 已完成 |
| T5 | 接口清单 v1.0（汇总 B/C/D 接口需求） | Day 2-3 | `05-接口清单v1.0.md` | ✅ 已完成（v1.0 定稿 67 接口） |
| T6 | 需求冻结 A 部分定稿、全员签字、交接 | Day 3 | `06-需求冻结A部分定稿.md` | ✅ 已完成 |

图例：⬜ 未开始 ｜ 🟦 进行中 ｜ ✅ 已完成　**A 第一阶段 6/6 全部完成 ✅**
