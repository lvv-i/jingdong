...
| B | 用户网页端 | 已确认 | 2026-08-12 | 无异议；用户端交互按此状态机实现 |
| C | 商家后台 + 管理员后台 | 已确认 | 2026-08-12 | 无异议；后台操作按钮按流转表显隐 |
| D | App / 小程序 + 测试 | 已确认 | 2026-08-12 | 无异议；测试用例按合法/禁止流转设计 |

> 签字方式：在本文件 GitHub 上以 PR 评论或线下签字后由 A 汇总填写。三人签字齐全后，本文件升版 v1.0。✅ **2026-08-12 全员签字齐全，已升 v1.0 定稿。**
...
- [x] B/C/D 三人签字齐全（姓名 + 日期）——2026-08-12 签字后升 v1.0 ✅
- [x] 无前端自创状态名、无数字状态码
