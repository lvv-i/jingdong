...
├── member-c/                 ← 成员C（商家后台+管理员后台）工作区 ★
└── member-d/                 ← 成员D（App/小程序）工作区（待 D 启动）
```
...
|------|------|----------------|----------------------|------------|
| B | 用户网页端 | Vue 3 + Vite + Element Plus 工程，完整购买闭环 | P-001~008 / U-001~025 | ⬜ 待启动 |
| C | 商家后台+管理员后台 | Vue 3 + Element Plus 共用工程（按角色分菜单），后台治理闭环 | M-001~015 / A-001~019 | 🟦 已建工作区 |
| D | App/小程序 | uni-app 工程，页面复用与端差异适配 | P/U 组为主 | ⬜ 待启动 |
